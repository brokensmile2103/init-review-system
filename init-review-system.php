 ...
 * Description: Add a simple and flexible star rating system with schema support, REST API, shortcode display, and localStorage tracking.
 * Version: 1.2
 * Author: Init HTML
...
define( 'INIT_PLUGIN_SUITE_RS_VERSION',        '1.2' );
